...
const Untitled1 = () => {
  return <View style={_styles.KinmefJZ}>
      <View style={_styles.RPELqcXz}></View><Text style={_styles.djxTICqP}>Lorem ipsum…</Text><ImageBackground style={_styles.jdLfmuXR} source={{
